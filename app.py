"""
This Flask application allows users to upload .txt files.

It extracts the content and returns a randomly selected paragraph
in JSON format.
"""
...
app.config['MAX_CONTENT_LENGTH'] = (
    16 * 1024 * 1024  # Limit upload file size to 16MB
)
...
def upload_file():
    ...
    Read content if it's a .txt file and return a random paragraph from it.
    """
